...
class Item(models.Model):
    ...
    korea_title = models.CharField(max_length=100, null=False, help_text='한국어 상품 제목')
    korea_contents = models.CharField(max_length=5000, null=False, help_text='한국어 상품 정보')
    english_title = models.CharField(max_length=100, null=True, help_text='영어 상품 제목')
    english_contents = models.CharField(max_length=5000, null=True, help_text='영어 상품 정보')
    china_title = models.CharField(max_length=100, null=True, help_text='중국 상품 제목')
    china_contents = models.CharField(max_length=5000, null=True, help_text='중국 상품 정보')
    price = models.IntegerField(null=False, help_text='상품 금액')
    sale_price = models.IntegerField(help_text='세일 상품 금액')
    commission_rate = models.FloatField(default=0.0, null=True, help_text='수수료')
